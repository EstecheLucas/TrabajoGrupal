...
document.getElementById("loadModel").onclick = async () => {
  ...
  updateModelLoadStatus("Cargando modelo...");

  const modelName =
    modelNameSelect.options[modelNameSelect.selectedIndex].value;
  await loadModel(modelName);
  updateModelLoadStatus("El modelo " + modelName + " esta cargado!");
